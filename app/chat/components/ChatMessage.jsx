...
export default function ChatMessage({
  ...
  // FIX: isCompact was passed from ChatWidget but not destructured here,
  // so it was silently dropped and never forwarded to ChatActions.
  // Result: Volume + Share buttons always rendered in widget mode.
  isCompact = false,
}) {
      ...
      <div className="flex flex-col gap-1 max-w-[88%] md:max-w-[70%]">
        {type === "decline" || type === "error" ? (
          ...
          <div className="flex flex-col">
            ...
            {/* Action buttons — only for AI messages, not while streaming */}
            {!isUser && !isStreaming && (
              <ChatActions
                messageIndex={index}
                content={content}
